...
# from urlparse import urlparse  # Python 2
    ...
    def scrape_callback(self, response):
        ...
        if response.result() and (http_status_code == "200"):
            ...
            dbfunctions.create_new_page(conn, site_id, 'NULL', target_url, 'NULL', html_content_hash, http_status_code, accessed_time)
        else:
    ...
    def parse_page (self, conn, html_content, url, http_status_code):
        ...
        if url != canonical:
            ...
            html_content_hash = None
            id = dbfunctions.create_new_page(conn, site_id, page_type_code, url, 'NULL', html_content_hash, http_status_code, accessed_time)
            ...
            id = dbfunctions.create_new_page(conn, site_id, page_type_code, url, html_content, html_content_hash, http_status_code, accessed_time)
